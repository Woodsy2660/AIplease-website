...
import { SlalomTrace } from "@/components/work/slalom-trace";
import {
  gcwscMeta,
  gcwscSections,
  type GcwscSection,
} from "@/lib/gcwsc-case-study";
function SectionPhoto({ image }: { image: GcwscSection["image"] }) {
  return (
...
function NarrativeSection({ section }: { section: GcwscSection }) {
      ...
      <section className="relative overflow-hidden bg-chocolate text-stone">
        ...
        <div className="relative mx-auto max-w-6xl px-5 pb-0 pt-6 sm:px-6 sm:pt-7 lg:px-8 lg:pt-8">
          ...
          <div className="mt-5 flex items-center gap-4">
            <Image
              src={gcwscMeta.logo}
              alt="Gold Coast Waterski Club logo"
              width={44}
              height={44}
